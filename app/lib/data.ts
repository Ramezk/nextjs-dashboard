...
export async function fetchCardData() {
  try {
    ...
    const totalPaidInvoices = formatCurrency(data[2] != undefined ? data[2]._sum.amount || 0 : 0);
    const totalPendingInvoices = formatCurrency(data[3] != undefined ? data[3]._sum.amount || 0 : 0);
